...
cyber_bg = "#000033"  # Dark blue background
cyber_fg = "#00ffcc"  # Neon blue-green text color
cyber_btn_bg = "#000022"  # Dark blue button color
cyber_btn_fg = "#00ffcc"  # Neon blue-green button text color
cyber_highlight = "#00ffcc"  # Neon blue-green highlight color
cyber_text_font = ("Verdana", 12, "bold")
...
class LanguageTranslatorApp:
    def __init__(self, root):
        ...
        self.label = Label(root, text="Enter Text:", bg=cyber_bg, fg=cyber_fg, font=cyber_text_font)
        self.label.pack()

        self.input_entry = Entry(root, width=40, bg=cyber_bg, fg=cyber_fg, font=cyber_text_font)
        self.input_entry.pack()

        self.language_label = Label(root, text="Select Target Language:", bg=cyber_bg, fg=cyber_fg, font=cyber_text_font)
        ...
        self.language_dropdown.config(bg=cyber_bg, fg=cyber_fg, font=cyber_text_font)
        self.language_dropdown.pack()

        self.translate_button = Button(root, text="Translate", command=self.translate, bg=cyber_btn_bg, fg=cyber_btn_fg, font=cyber_text_font, highlightbackground=cyber_highlight)
        self.translate_button.pack()

        self.output_label = Label(root, text="Translated Text:", bg=cyber_bg, fg=cyber_fg, font=cyber_text_font)
        self.output_label.pack()

        self.output_text = Text(root, width=40, height=4, bg=cyber_bg, fg=cyber_fg, font=cyber_text_font)
...
class SpeechTranslatorApp:
    def __init__(self, root):
        ...
        self.translation_label = Label(root, text="", bg=cyber_bg, fg=cyber_fg, font=cyber_text_font)
        self.translation_label.pack()

        self.recognize_button = Button(root, text="Start Speech Recognition", command=self.recognize_and_translate, bg=cyber_btn_bg, fg=cyber_btn_fg, font=cyber_text_font, highlightbackground=cyber_highlight)
...
class PDFTranslatorApp:
    def __init__(self, root):
        ...
        self.upload_button = Button(root, text="Upload PDF", command=self.translate_pdf, bg=cyber_btn_bg, fg=cyber_btn_fg, font=cyber_text_font, highlightbackground=cyber_highlight)
        ...
        self.result_text = Text(root, height=10, width=40, bg=cyber_bg, fg=cyber_fg, font=cyber_text_font)
